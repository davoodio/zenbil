                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                              ...
                                              children: [
                                                Flexible(
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'g456xjd2' /* Your payment has been successf... */,
                                                    ),
                                                    textAlign: TextAlign.center,
                                                    maxLines: 3,
                                                    style: FlutterFlowTheme.of(
                                ...
                                FutureBuilder<List<OrderProductsRow>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<OrderProductsRow>
                                        columnOrderProductsRowList =
                                        snapshot.data!;

                                    final columnOrderProductsRow =
                                        columnOrderProductsRowList.isNotEmpty
                                            ? columnOrderProductsRowList.first
                                            : null;
                                        ...
                                        Padding(
                                          ...
                                          child: wrapWithModel(
                                            ...
                                            child: OrderHistoryItemWidget(
                                              photo: columnOrderProductsRow
                                                  ?.productImage,
                                              productName:
                                                  columnOrderProductsRow?.name,
                                              price: columnOrderProductsRow
                                                  ?.priceTotal,
                                              showReview: false,
                                            ),
                                          ),
