                                                ...
                                                onRatingUpdate: (newValue) {
                                                  safeSetState(() =>
                                                      _model.ratingBarValue =
                                                          newValue);
                                                  logFirebaseEvent(
                                                      'FEED_BACK_PAGE_RatingBar_w7yaa1v5_ON_TAP');
                                                  logFirebaseEvent(
                                                      'RatingBar_update_page_state');
                                  ...
                                  Expanded(
                                    child: Semantics(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: !_model.ratingSet
                                            ? null
                                            : () async {
                                                logFirebaseEvent(
                                                    'FEED_BACK_PAGE_SUBMIT_BTN_ON_TAP');
                                                logFirebaseEvent(
                                                    'Button_backend_call');
                                                await ProductReviewsTable()
                                                    .insert({
                                                  'status':
