                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'x9hi2ojh' /* Choice a unique user name */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelSmall
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                ...
                                                text: editProfileUsersRow
                                                    ...
                                                    ? editProfileUsersRow
                                                        ?.userName
                                                    : '${FFAppConstants.BrandAppName}${random_data.randomString(
                                                        10,
                                                        12,
                                                        true,
                                                        true,
                                ...
                                Expanded(
                                  child: Semantics(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'EDIT_PROFILE_PAGE_updateUser_ON_TAP');
                                        logFirebaseEvent(
                                            'updateUser_validate_form');
                                        ...
                                        await UsersTable().update(
                                          data: {
                                            ...
                                            'display_name':
                                                '${_model.nameTextFieldTextController.text} ${_model.lastNameTextController.text}',
                                            'avatar_url': _model
                                                .avatarWithUpdateModel
                                                .avatarURL,
                                            'user_name': _model
