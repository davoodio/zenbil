                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        functions.applyCorrectNumberFormatting(
                                                            double.parse((functions.calculateCartTotalPrice(FFAppState()
                                                                        .Cart
                                                                        .products
                                                                        .toList()) *
                                                                    FFAppState()
                                                        ...
                                                        _model.orderGroup =
                                                          ...
                                                          'status':
                                                              OrderStatuses
                                                                  .Draft.name,
                                                          'price_sub_total': functions
                                                              .calculateOrderGroupTotalInCart(
                                                                  FFAppState()
                                                                      .Cart
                                                                      .products
                                                                      .toList(),
                                                                  _model.uniqueBusinesses[
                                                                      _model
                                                                          .counterOrderGroup],
                                                                  _model.uniqueBusinessWarehouses[
                                                                      _model
                                                                          .counterWarehouse]),
                                                                ...
                                                                .where((e) =>
                                                                    (e.businessId ==
                                                                        _model.uniqueBusinesses[_model
                                                                            .counterOrderGroup]) &&
                                                                    (e.warehouseId ==
                                                                        _model.uniqueBusinessWarehouses[_model
                                                                            .counterWarehouse]))
                                                                .toList()
                                                                .length >
                                                            _model
