...
class ViewOrderAdminTable extends SupabaseTable<ViewOrderAdminRow> {
  @override
  String get tableName => 'view_order_admin';

  @override
  ViewOrderAdminRow createRow(Map<String, dynamic> data) =>
      ViewOrderAdminRow(data);
}

class ViewOrderAdminRow extends SupabaseDataRow {
  ViewOrderAdminRow(super.data);

  @override
  SupabaseTable get table => ViewOrderAdminTable();
  ...
  List<int> get businessIds => getListField<int>('business_ids');
  set businessIds(List<int>? value) => setListField<int>('business_ids', value);

  List<String> get businessNames => getListField<String>('business_names');
  set businessNames(List<String>? value) =>
      setListField<String>('business_names', value);
}
