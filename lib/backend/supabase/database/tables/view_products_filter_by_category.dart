...
class ViewProductsFilterByCategoryTable
    extends SupabaseTable<ViewProductsFilterByCategoryRow> {
  @override
  String get tableName => 'view_products_filter_by_category';

  @override
  ViewProductsFilterByCategoryRow createRow(Map<String, dynamic> data) =>
      ViewProductsFilterByCategoryRow(data);
}
...
class ViewProductsFilterByCategoryRow extends SupabaseDataRow {
  ...
  String? get productBarcode => getField<String>('product_barcode');
  set productBarcode(String? value) =>
      setField<String>('product_barcode', value);

  bool? get productAvailableForMarketers =>
      getField<bool>('product_available_for_marketers');
  set productAvailableForMarketers(bool? value) =>
      setField<bool>('product_available_for_marketers', value);

  int? get productQuantityInInventory =>
      getField<int>('product_quantity_in_inventory');
  set productQuantityInInventory(int? value) =>
      setField<int>('product_quantity_in_inventory', value);
