...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/pinCodeVerification',
          builder: (context, params) => PinCodeVerificationWidget(
            phoneNumber: params.getParam(
              'phoneNumber',
              ParamType.String,
            ),
            countryId: params.getParam(
              'countryId',
              ParamType.int,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) => TrackOrderWidget(
            orderGroup: params.getParam<OrderGroupsRow>(
              'orderGroup',
        ...
        FFRoute(
          ...
          builder: (context, params) => CheckoutWidget(
            ...
            orderGroups: params.getParam<OrderGroupsRow>(
              'orderGroups',
              ParamType.SupabaseRow,
              isList: true,
            ),
            orderproducts: params.getParam<OrderProductsRow>(
              'orderproducts',
              ParamType.SupabaseRow,
              isList: true,
            ),
        ...
        FFRoute(
          ...
          path: '/orderConfirmation/:order',
          requireAuth: true,
          builder: (context, params) => OrderConfirmationWidget(
            order: params.getParam<OrdersRow>(
              'order',
              ParamType.SupabaseRow,
            ),
        ...
        FFRoute(
          ...
          builder: (context, params) => SearchWidget(
            tableName: params.getParam(
              'tableName',
              ParamType.String,
            ),
            fieldsToReturnFromTable: params.getParam(
              'fieldsToReturnFromTable',
              ParamType.String,
            ),
            fieldsToSearchIn: params.getParam(
              'fieldsToSearchIn',
              ParamType.String,
            ),
            searchTitle: params.getParam(
              'searchTitle',
              ParamType.String,
            ),
            preDefineSearch: params.getParam(
              'preDefineSearch',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          ...
          path: '/ratingsReviews',
          requireAuth: true,
          builder: (context, params) => RatingsReviewsWidget(
            product: params.getParam<ProductsRow>(
              'product',
              ParamType.SupabaseRow,
            ),
            marketId: params.getParam(
        ...
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => ProductsCategoryWidget(
        ...
        FFRoute(
          ...
          path: '/stars',
          requireAuth: true,
          builder: (context, params) => StarsWidget(
            showBackButton: params.getParam(
              'showBackButton',
              ParamType.bool,
            ),
        ...
        FFRoute(
          name: 'StoreFront',
          path: '/store',
          builder: (context, params) => StoreFrontWidget(
            marketID: params.getParam(
              'marketID',
              ParamType.int,
            ),
        ...
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => ReviewConfirmationWidget(
            productId: params.getParam(
              'productId',
              ParamType.int,
            ),
        ...
        FFRoute(
          ...
          path: '/FIBPayment',
          requireAuth: true,
          builder: (context, params) => FIBPaymentWidget(
            ...
            paymentAmount: params.getParam(
              'paymentAmount',
              ParamType.double,
            ),
            transaction: params.getParam<TransactionsRow>(
              'transaction',
              ParamType.SupabaseRow,
            ),
        ...
        FFRoute(
          ...
          path: '/addDomesticAddress',
          requireAuth: true,
          builder: (context, params) => AddDomesticAddressWidget(
